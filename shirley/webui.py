...
class WebUI(object):
    ...
    def _make_blocks(self, *args, **kwargs) -> gr.Blocks:
        with gr.Blocks(theme=gr.themes.Default(), title='Shirley WebUI') as blocks:
            ...
            gr.Markdown(
                value='<font size=2>This WebUI is governed by the original license of Qwen-VL-Chat. We strongly advise \
                ...
                (本WebUI受通义千问的许可协议限制。我们强烈建议，用户不应传播及不应允许他人传播以下内容，包括但不限于仇恨言论、\
                暴力、色情、欺诈相关的有害信息。)'
            )
